...
public class SecurityConfig {
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    http
        ...
        .authorizeHttpRequests(authorize -> authorize
            ...
            .requestMatchers(HttpMethod.GET, "/scholarships", "/scholarships/*").permitAll()
            .requestMatchers(HttpMethod.GET, "/provider-invites/*").permitAll()
            .requestMatchers(HttpMethod.POST, "/provider-invites/*/accept").permitAll()
  ...
  private CorsConfigurationSource corsConfigurationSource() {
    ...
    if ("*".equals(corsAllowedOrigin)) {
      ...
      configuration.setAllowedOrigins(List.of(corsAllowedOrigin.split(",")));
    }
